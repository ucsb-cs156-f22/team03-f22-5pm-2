...
@Api(description = "HelpRequestController")
...
public class HelpRequestController extends ApiController {
    ...
    public HelpRequest getById(
        ...
        HelpRequest helpRequest = helpRequestRepository.findById(id).orElseThrow(() -> new EntityNotFoundException(HelpRequest.class, id));
        return helpRequest;
    }
    ...
    @PostMapping("/post")
    public HelpRequest postRequests(
    ...
    public Object deleteHelpRequest(
        ...
        HelpRequest requests = helpRequestRepository.findById(id)
    ...
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    @PutMapping("")
    public HelpRequest updateRequests(
            @ApiParam("id") @RequestParam Long id,
