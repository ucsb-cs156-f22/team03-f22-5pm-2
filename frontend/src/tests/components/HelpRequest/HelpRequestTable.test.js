...
describe("HelpRequestTable tests", () => {
  ...
  test("Has the expected column headers and content for adminUser", () => {
    ...
    const expectedHeaders = ["id", "requesterEmail", "teamId", "tableOrBreakoutRoom", "explanation", "solved"];
    const expectedFields = ["id", "requesterEmail", "teamId", "tableOrBreakoutRoom", "explanation", "solved"];
