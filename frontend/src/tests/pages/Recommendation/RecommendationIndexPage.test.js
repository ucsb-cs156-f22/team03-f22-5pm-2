...
describe("UCSBDatesIndexPage tests", () => {
  ...
  test("renders three diningCommon without crashing for regular user", async () => {
    ...
    const queryClient = new QueryClient();
    axiosMock
      .onGet("/api/ucsbdiningcommons/all")
      .reply(200, diningCommonsFixtures.threeCommons);
  ...
  test("test what happens when you click delete, admin", async () => {
    ...
    axiosMock
      ...
      .reply(200, diningCommonsFixtures.threeCommons);
    axiosMock
      .onDelete("/api/ucsbdiningcommons", { params: { code: "de-la-guerra" } })
      .reply(200, "DiningCommons with id de-la-guerra was deleted");
    ...
    await waitFor(() => {
      expect(mockToast).toBeCalledWith(
        "DiningCommons with id de-la-guerra was deleted"
      );
    });
  });
  ...
  test("test what happens when you click edit as an admin", async () => {
    ...
    await waitFor(() =>
      expect(mockedNavigate).toHaveBeenCalledWith(
        "/diningCommons/edit/de-la-guerra"
      )
    );
  });
});
